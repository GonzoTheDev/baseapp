...
export const en = {
    ...
    'page.body.landing.marketInfo.title.text1': 'Welcome to CryptX.',
    ...
    'page.body.landing.platformInfo.item.second.value': '฿5+',
    'page.body.landing.platformInfo.item.second.title': '30 days volume',
    'page.body.landing.platformInfo.item.third.value': '100+',
    'page.body.landing.platformInfo.item.third.title': 'Registered Users',
    ...
    'page.body.landing.features.title': 'CryptX platform features',
    ...
    'page.body.landing.features.features.item1.text': 'CryptX offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'CryptX offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.tradeOnTheGo.item.text3': 'All the power of CryptX cryptocurrency exchange, in the palm of your hand.',
    ...
    'page.body.landing.footer.rights': 'CryptX © All rights reserved. 2021',
